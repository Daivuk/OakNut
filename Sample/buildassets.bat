...
"../OakNut/tools/bin/FBXConverter.exe" srcAssets/meshes/floor.fbx assets/meshes/floor.mesh -bump on -scale .5
"../OakNut/tools/bin/FBXConverter.exe" srcAssets/meshes/floor2.fbx assets/meshes/floor2.mesh -bump on -scale .5
"../OakNut/tools/bin/FBXConverter.exe" srcAssets/meshes/wall1.fbx assets/meshes/wall1.mesh -bump on -scale .5
